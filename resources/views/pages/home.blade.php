            ...
            <div class="row justify-content-end">
                <div class="col-xl-10">
                    <div class="slider-active">
                        <div class="single-slider slider-bg" data-background="{{ asset('assets/img/slider/s_slider_bg01.jpg') }} ">
                        ...
                        <div class="single-slider slider-bg" data-background="{{ asset('assets/img/slider/s_slider_bg02.jpg') }}">
                            <div class="slider-content">
                                <h5 data-animation="fadeInUp" data-delay=".3s">top deal !</h5>
                        ...
                        <div class="single-slider slider-bg" data-background="{{ asset('assets/img/slider/s_slider_bg03.jpg') }}">
                            <div class="slider-content">
                                <h5 data-animation="fadeInUp" data-delay=".3s">top deal !</h5>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6">
                    <div class="top-cat-banner-item mt-30">
                        <a href="shop-left-sidebar.html"><img src="{{ asset('assets/img/images/top_cat_banner01.jpg') }}" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="top-cat-banner-item mt-30">
                        <a href="shop-left-sidebar.html"><img src="{{ asset('assets/img/images/top_cat_banner02.jpg') }}" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="top-cat-banner-item mt-30">
                        <a href="shop-left-sidebar.html"><img src="{{ asset('assets/img/images/top_cat_banner03.jpg') }}" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-10">
                    <div class="product-menu mb-60">
                        <button class="active" data-filter="*">Top ventes</button>
            ...
            <div class="row exclusive-active">
                    ...
                    <div class="mb-40 exclusive-item exclusive-item-two">
                        <div class="exclusive-item-thumb">
                            <a href="shop-details.html">
                                <img src="assets/img/product/s_exclusive_product01.png" alt="">
                                <img class="overlay-product-thumb" src="assets/img/product/s_exclusive__product01.png" alt="">
                            </a>
                            <span class="discount">35%</span>
                            <span class="sd-meta">New!</span>
                            <a href="cart.html" class="to-cart">Ajouter au panier <i class="fas fa-cart-plus"></i></a>
                        </div>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6 grid-item grid-sizer cat-one cat-three">
                    <div class="mb-40 exclusive-item exclusive-item-two">
                        <div class="exclusive-item-thumb">
                            <a href="shop-details.html">
                                <img src="assets/img/product/s_exclusive_product02.png" alt="">
                                <img class="overlay-product-thumb" src="assets/img/product/s_exclusive__product02.png" alt="">
                            </a>
                            <span class="sd-meta">New!</span>
                            <a href="cart.html" class="to-cart">Ajouter au panier <i class="fas fa-cart-plus"></i></a>
                        </div>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6 grid-item grid-sizer cat-two">
                    <div class="mb-40 exclusive-item exclusive-item-two">
                        <div class="exclusive-item-thumb">
                            <a href="shop-details.html">
                                <img src="assets/img/product/s_exclusive_product03.png" alt="">
                                <img class="overlay-product-thumb" src="assets/img/product/s_exclusive__product03.png" alt="">
                            </a>
                            <span class="sd-meta">New!</span>
                            <a href="cart.html" class="to-cart">Ajouter au panier <i class="fas fa-cart-plus"></i></a>
                        </div>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6 grid-item grid-sizer cat-one cat-three">
                    <div class="mb-40 exclusive-item exclusive-item-two">
                        <div class="exclusive-item-thumb">
                            <a href="shop-details.html">
                                <img src="assets/img/product/s_exclusive_product04.png" alt="">
                                <img class="overlay-product-thumb" src="assets/img/product/s_exclusive__product04.png" alt="">
                            </a>
                            <span class="sd-meta">New!</span>
                            <a href="cart.html" class="to-cart">Ajouter au panier <i class="fas fa-cart-plus"></i></a>
                        </div>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6 grid-item grid-sizer cat-two cat-three">
                    <div class="mb-40 exclusive-item exclusive-item-two">
                        <div class="exclusive-item-thumb">
                            <a href="shop-details.html">
                                <img src="assets/img/product/s_exclusive_product05.png" alt="">
                                <img class="overlay-product-thumb" src="assets/img/product/s_exclusive__product05.png" alt="">
                            </a>
                            <span class="sd-meta">New!</span>
                            <a href="cart.html" class="to-cart">Ajouter au panier <i class="fas fa-cart-plus"></i></a>
                        </div>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6 grid-item grid-sizer cat-one">
                    <div class="mb-40 exclusive-item exclusive-item-two">
                        <div class="exclusive-item-thumb">
                            <a href="shop-details.html">
                                <img src="assets/img/product/s_exclusive_product06.png" alt="">
                                <img class="overlay-product-thumb" src="assets/img/product/s_exclusive__product06.png" alt="">
                            </a>
                            <span class="sd-meta">New!</span>
                            <a href="cart.html" class="to-cart">Ajouter au panier <i class="fas fa-cart-plus"></i></a>
                        </div>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6 grid-item grid-sizer cat-two cat-one cat-three">
                    <div class="mb-40 exclusive-item exclusive-item-two">
                        <div class="exclusive-item-thumb">
                            <a href="shop-details.html">
                                <img src="assets/img/product/s_exclusive_product07.png" alt="">
                                <img class="overlay-product-thumb" src="assets/img/product/s_exclusive__product07.png" alt="">
                            </a>
                            <span class="discount">35%</span>
                            <span class="sd-meta">New!</span>
                            <a href="cart.html" class="to-cart">Ajouter au panier <i class="fas fa-cart-plus"></i></a>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6 grid-item grid-sizer cat-one cat-two">
                    <div class="mb-40 exclusive-item exclusive-item-two">
                        <div class="exclusive-item-thumb">
                            <a href="shop-details.html">
                                <img src="assets/img/product/s_exclusive_product08.png" alt="">
                                <img class="overlay-product-thumb" src="assets/img/product/s_exclusive__product08.png" alt="">
                            </a>
                            <span class="sd-meta">New!</span>
                            <a href="cart.html" class="to-cart">Ajouter au panier <i class="fas fa-cart-plus"></i></a>
                        </div>
            ...
            <div class="row">
                <div class="custom-col-4">
                    <div class="deal-of-day-banner mb-30">
                        <a href="shop-left-sidebar.html"><img src="assets/img/product/deal_banner.jpg" alt=""></a>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-4 col-md-6 mb-50">
                    ...
                    <div class="mb-20 list-product-item">
                        <div class="list-product-thumb">
                            <a href="shop-details.html"><img src="assets/img/product/list_product_thumb01.png" alt=""></a>
                        </div>
                    ...
                    <div class="mb-20 list-product-item">
                        <div class="list-product-thumb">
                            <a href="shop-details.html"><img src="assets/img/product/list_product_thumb02.png" alt=""></a>
                        </div>
                        <div class="list-product-content">
                ...
                <div class="col-xl-4 col-md-6 mb-50">
                    ...
                    <div class="mb-20 list-product-item">
                        <div class="list-product-thumb">
                            <a href="shop-details.html"><img src="assets/img/product/list_product_thumb03.png" alt=""></a>
                        </div>
                        <div class="list-product-content">
                    ...
                    <div class="mb-20 list-product-item">
                        <div class="list-product-thumb">
                            <a href="shop-details.html"><img src="assets/img/product/list_product_thumb04.png" alt=""></a>
                        </div>
                        <div class="list-product-content">
                            <h6><a href="shop-details.html">Stylish Bag</a></h6>
                            <p>US $ 21.99<span>{ 50% off }</span></p>
                ...
                <div class="col-xl-4 col-md-6 mb-50">
                    ...
                    <div class="mb-20 list-product-item">
                        <div class="list-product-thumb">
                            <a href="shop-details.html"><img src="assets/img/product/list_product_thumb05.png" alt=""></a>
                        </div>
                        <div class="list-product-content">
                    ...
                    <div class="mb-20 list-product-item">
                        <div class="list-product-thumb">
                            <a href="shop-details.html"><img src="assets/img/product/list_product_thumb06.png" alt=""></a>
                        </div>
                        <div class="list-product-content">
